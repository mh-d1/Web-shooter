window.addEventListener('DOMContentLoaded', function(){
    ...
    function initGame(){
        ...
        playerObj.position.set(0,2+1,5);
        scene.add(playerObj);
        ...
        if(!isMobile){
            document.addEventListener('keydown',function(e){
                switch(e.code){
                    ...
                    case 'Space': if(controls.getObject().position.y<=2.01) isJumping=true; break;
                }
            });
            ...
            if(jumpBtn) jumpBtn.addEventListener("touchstart",function(){if(controls.getObject().position.y<=2.01) isJumping=true;});
